botonLiberacionCurso.addEventListener("click", function(){
    ...
    <panel-subir-archivo titulo="Ficha técnica" urlInformacion="/archivo/registroArchivosSubidos"urlEnviar="/archivo/liberacionCurso" idConjunto="2" idsql="${opcionSeleccionada.attributes.idsql.value}"></panel-subir-archivo>
    <panel-subir-archivo titulo="Evidencias" urlInformacion="/archivo/registroArchivosSubidos"urlEnviar="/archivo/liberacionCurso" idConjunto="2" idsql="${opcionSeleccionada.attributes.idsql.value}"></panel-subir-archivo>`
